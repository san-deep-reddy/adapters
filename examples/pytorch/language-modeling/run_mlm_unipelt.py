...
import evaluate
import transformers
from adapters.composition import Fuse, Stack, Split, Parallel, BatchSplit
from adapters import AdapterArguments, AdapterTrainer, setup_adapter_training, LoRAConfig, PrefixTuningConfig, SeqBnConfig, DoubleSeqBnConfig, ConfigUnion, UniPELTConfig
